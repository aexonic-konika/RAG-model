...
from langchain_ollama import ChatOllama  # Ensure this supports Llama 3.2 Vision or replace with the appropriate class
...
class ChatbotManager:
    def __init__(
        ...
        Args:
            ...
            llm_model (str): The local LLM model name for Llama 3.2 Vision.
        ...
        self.llm = ChatOllama(
            ...
            # Add additional parameters specific to Llama Vision if needed
        )
...
"""
    ...
    def get_response(self, query: str) -> str:
        ...
        try:
            ...
            st.error("⚠️ Unable to connect to Qdrant. Please ensure the Qdrant service is running.")
